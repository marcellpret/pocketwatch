  ...
  <div class="space-y-8">
    ...
    <section class="space-y-4">
      <div class="flex items-center justify-between">
        <h2 class="text-xs font-semibold uppercase tracking-widest text-muted-foreground">Workspaces</h2>
        <button
      ...
      <template v-if="workspace">
        <div class="rounded-2xl border border-border bg-card p-5">
          <h3 class="mb-1 text-sm font-semibold">{{ workspace.name }} — members & invitations</h3>
    ...
    <section class="space-y-4">
      <div class="flex items-center justify-between">
        <h2 class="text-xs font-semibold uppercase tracking-widest text-muted-foreground">Categorization</h2>
        <NuxtLink to="/categories" class="text-sm font-medium text-brand-600 hover:underline">
          Manage categories
        </NuxtLink>
      </div>

      <AutoCategorization v-if="workspace" />
      <p v-else class="text-sm text-muted-foreground">Select a workspace to manage categorization rules.</p>
    </section>

    <!-- Apple Pay -->
    <section class="space-y-4">
      <h2 class="text-xs font-semibold uppercase tracking-widest text-muted-foreground">Apple Pay</h2>
      <ApplePaySync />
    </section>

    <!-- General -->
    <section class="space-y-4">
      <h2 class="text-xs font-semibold uppercase tracking-widest text-muted-foreground">General</h2>
...
import { LogOut, Pencil, Plus, Trash2 } from 'lucide-vue-next'
